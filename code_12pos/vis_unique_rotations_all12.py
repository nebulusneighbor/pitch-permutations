...
# Visualize unique rotations for n=12 (12 positions) and all values of k (1 to 12)
n = 12
for k in range(1, n + 1):  # Start from 1 since we need at least one '1' at the first position
